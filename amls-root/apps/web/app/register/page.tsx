        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-yellow-400 hover:bg-yellow-500 disabled:bg-yellow-300 disabled:text-gray-600 text-gray-900 font-bold py-3 rounded-lg mt-2 transition-colors flex justify-center items-center"
            >
              {loading ? (
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              type="button"
              className="w-full flex items-center justify-center gap-2 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              type="button"
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors text-sm font-medium disabled:opacity-50"
            >
